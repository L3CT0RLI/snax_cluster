...
#ifndef VERILATED_VFPU_CSA_42_COMPRESS__O1D_H_
#define VERILATED_VFPU_CSA_42_COMPRESS__O1D_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VFPU_csa_42_compress__O1d final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __PVT__gen__BRA__28__KET____DOT__csa_1bit_compressor_i__DOT__mid2;
    VL_IN(op1,28,0);
    VL_IN(op2,28,0);
    VL_IN(op3,28,0);
    VL_IN(op4,28,0);
    VL_OUT(C,29,0);
    VL_OUT(S,29,0);
    IData/*29:0*/ __PVT__E_in;

    // INTERNAL VARIABLES
    VFPU__Syms* const vlSymsp;

    // CONSTRUCTORS
    VFPU_csa_42_compress__O1d(VFPU__Syms* symsp, const char* v__name);
    ~VFPU_csa_42_compress__O1d();
    VL_UNCOPYABLE(VFPU_csa_42_compress__O1d);
