...
extern const VlWide<21>/*671:0*/ VFPU__ConstPool__CONST_hf3a9d4f5_0;
...
VL_ATTR_COLD void VFPU_log2_X___eval_initial__TOP__FPU__DOT__gen_pe__BRA__0__KET____DOT__u_PE_top__u_log2_X_0(VFPU_log2_X* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          VFPU_log2_X___eval_initial__TOP__FPU__DOT__gen_pe__BRA__0__KET____DOT__u_PE_top__u_log2_X_0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_READMEM_N(true, 16, 32, 0, VL_CVT_PACK_STR_NW(21, VFPU__ConstPool__CONST_hf3a9d4f5_0)
...
VL_ATTR_COLD void VFPU_log2_X___stl_sequent__TOP__FPU__DOT__gen_pe__BRA__0__KET____DOT__u_PE_top__u_log2_X_0__0(VFPU_log2_X* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VFPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VFPU_log2_X___stl_sequent__TOP__FPU__DOT__gen_pe__BRA__0__KET____DOT__u_PE_top__u_log2_X_0__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void VFPU_log2_X___ctor_var_reset(VFPU_log2_X* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VFPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VFPU_log2_X___ctor_var_reset\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
