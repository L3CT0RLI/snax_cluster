...
VL_ATTR_COLD void VPE_top__2_power_X___eval_initial__TOP__PE_top__DOT__u___05F2_power_X_2(VPE_top__2_power_X* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          VPE_top__2_power_X___eval_initial__TOP__PE_top__DOT__u___05F2_power_X_2\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_READMEM_N(true, 16, 32, 0, VL_CVT_PACK_STR_NW(21, VPE_top__ConstPool__CONST_h40ab0002_0)
                 ,  &(vlSelfRef.__PVT__u_dual_port_ram_pos__DOT__ram)
                 , 0, ~0ULL);
}

VL_ATTR_COLD void VPE_top__2_power_X___ctor_var_reset(VPE_top__2_power_X* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VPE_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VPE_top__2_power_X___ctor_var_reset\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__en_stage_5 = VL_RAND_RESET_I(1);
