...
VL_INLINE_OPT void VPE_top__2_power_X___nba_sequent__TOP__PE_top__DOT__u___05F2_power_X_2__3(VPE_top__2_power_X* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VPE_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VPE_top__2_power_X___nba_sequent__TOP__PE_top__DOT__u___05F2_power_X_2__3\n"); );
...
VL_INLINE_OPT void VPE_top__2_power_X___nba_comb__TOP__PE_top__DOT__u___05F2_power_X_2__0(VPE_top__2_power_X* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VPE_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VPE_top__2_power_X___nba_comb__TOP__PE_top__DOT__u___05F2_power_X_2__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
